...
data_dir <- "C:/Users/jjew0003/Documents/BarcelonaProjects/GraphicalModels_NetworkData/COVID_DATA"
```
...
source("C:/Users/jjew0003/Documents/BarcelonaProjects/GraphicalModels_NetworkData/GOLAZO_function_pd_solve.R")
library(polynom)
...
Flights1 <- as.matrix(read_csv("flights_332_meta_capacity.csv"))[,-1]
...
edges_for_plot_transformed <- usmap_transform(edges_for_plot, input_names = c("x", "y"))   %>% arrange(to) %>% arrange(from)
edges_for_plot_transformed2 <- usmap_transform(edges_for_plot, input_names = c("xend", "yend"))   %>% arrange(to) %>% arrange(from)

# Merging transformed edge coordinates into a single data frame
merged_data_sf <- cbind(edges_for_plot_transformed, edges_for_plot_transformed2)
...
plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  geom_segment(data = merged_data_sf, 
  ...
  geom_point(data = nodes_transformed, 
...
Motivation for spike and slab extension, plotitng the mean of non-zeros and proportion of 0s with the networks (all equi-spaced bins)

```{r GLASSO_vs_A1_2_mean, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

# Calculate the mean of non-zero values of partial_corr_GLASSO for each bin
mean_non_zero <- aggregate(df_A1_plot$partial_corr_GLASSO, list(df_A1_plot$A1_plot_bin), FUN = function(x) mean(x[x != 0]))

# Plot the scatter plot
plot(A1_plot_bin_mid, mean_non_zero$x, xlab = "Geographical Closeness Network ($A_1$)", ylab = "Mean of non-zero estimates", main = "")


```

```{r GLASSO_vs_A1_2_mean_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 3, fig.width = 5, dev = "tikz"}
...
# Plot the scatter plot
plot(A1_plot_bin_mid, mean_non_zero$x, xlab = "Geographical Closeness Network ($A_1$)", ylab = "$\\hat{E}[\\rho_{ij} | \\rho_{ij} \\neq 0, A_1]$", main = "")


```

```{r GLASSO_vs_A1_2_logit, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

non_zero_counts <- aggregate(as.numeric(df_A1_plot$partial_corr_GLASSO != 0), list(df_A1_plot$A1_plot_bin), sum)
zero_counts <- aggregate(as.numeric(df_A1_plot$partial_corr_GLASSO == 0), list(df_A1_plot$A1_plot_bin), sum)

# Calculate the logit proportion of non-zero values
logit_proportions <- log(non_zero_counts$x / zero_counts$x )
# Plot the scatter plot
plot(A1_plot_bin_mid, logit_proportions, xlab = "Geographical Closeness Network ($A_1$)", ylab = "logit proportion of non-zero estimates", main = "")


```

```{r GLASSO_vs_A1_2_logit_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 3, fig.width = 5, dev = "tikz"}
par(mar = c(3.5, 3.8, 1.5, 1.1)) # bottom, left, top, right
#par(mar = c(5.1, 4.1, 4.1, 2.1)) # Default
#par(mgp = c(3, 1, 0)) # Default - location of xlab and ylab, tick-mark labels, tick marks.
par(mgp = c(2.15, 1, 0))
...
logit_proportions <- log(non_zero_counts$x / zero_counts$x )
# Plot the scatter plot
plot(A1_plot_bin_mid, logit_proportions, xlab = "Geographical Closeness Network ($A_1$)", ylab = "logit$\\hat{P}[\\rho_{ij} \\neq 0 | A_1]$", main = "")
...
```{r GLASSO_vs_A2_2_mean, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

# Calculate the mean of non-zero values of partial_corr_GLASSO for each bin
mean_non_zero <- aggregate(df_A2_plot$partial_corr_GLASSO, list(df_A2_plot$A2_plot_bin), FUN = function(x) mean(x[x != 0]))

# Plot the scatter plot
plot(A2_plot_bin_mid, mean_non_zero$x, xlab = "Facebook Connectivity Index ($A_2$)", ylab = "Mean of non-zero estimates", main = "")


```

```{r GLASSO_vs_A2_2_mean_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 3, fig.width = 5, dev = "tikz"}
...
# Plot the scatter plot
plot(A2_plot_bin_mid, mean_non_zero$x, xlab = "Facebook Connectivity Index ($A_2$)", ylab = "$\\hat{E}[\\rho_{ij} | \\rho_{ij} \\neq 0, A_2]$", main = "")


```

```{r GLASSO_vs_A2_2_logit, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

non_zero_counts <- aggregate(as.numeric(df_A2_plot$partial_corr_GLASSO != 0), list(df_A2_plot$A2_plot_bin), sum)
zero_counts <- aggregate(as.numeric(df_A2_plot$partial_corr_GLASSO == 0), list(df_A2_plot$A2_plot_bin), sum)

# Calculate the logit proportion of non-zero values
logit_proportions <- log(non_zero_counts$x / zero_counts$x )
# Plot the scatter plot
plot(A2_plot_bin_mid, logit_proportions, xlab = "Facebook Connectivity Index ($A_2$)", ylab = "logit proportion of non-zero estimates", main = "")


```

```{r GLASSO_vs_A2_2_logit_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 3, fig.width = 5, dev = "tikz"}
par(mar = c(3.5, 3.8, 1.5, 1.1)) # bottom, left, top, right
#par(mar = c(5.1, 4.1, 4.1, 2.1)) # Default
#par(mgp = c(3, 1, 0)) # Default - location of xlab and ylab, tick-mark labels, tick marks.
par(mgp = c(2.15, 1, 0))
...
logit_proportions <- log(non_zero_counts$x / zero_counts$x )
# Plot the scatter plot
plot(A2_plot_bin_mid, logit_proportions, xlab = "Facebook Connectivity Index ($A_2$)", ylab = "logit$\\hat{P}[\\rho_{ij} \\neq 0 | A_2]$", main = "")
...
```{r GLASSO_vs_A3_2_mean, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

# Calculate the mean of non-zero values of partial_corr_GLASSO for each bin
mean_non_zero <- aggregate(df_A3_plot$partial_corr_GLASSO, list(df_A3_plot$A3_plot_bin), FUN = function(x) mean(x[x != 0]))

# Plot the scatter plot
plot(A3_plot_bin_mid, mean_non_zero$x, xlab = "Flights Connectivity Network ($A_3$)", ylab = "Mean of non-zero estimates", main = "")


```

```{r GLASSO_vs_A3_2_mean_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 3, fig.width = 5, dev = "tikz"}
...
# Plot the scatter plot
plot(A3_plot_bin_mid, mean_non_zero$x, xlab = "Flights Connectivity Network ($A_3$)", ylab = "$\\hat{E}[\\rho_{ij} | \\rho_{ij} \\neq 0, A_3]$", main = "")


```

```{r GLASSO_vs_A3_2_logit, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

non_zero_counts <- aggregate(as.numeric(df_A3_plot$partial_corr_GLASSO != 0), list(df_A3_plot$A3_plot_bin), sum)
zero_counts <- aggregate(as.numeric(df_A3_plot$partial_corr_GLASSO == 0), list(df_A3_plot$A3_plot_bin), sum)

# Calculate the logit proportion of non-zero values
logit_proportions <- log(non_zero_counts$x / zero_counts$x )
# Plot the scatter plot
plot(A3_plot_bin_mid, logit_proportions, xlab = "Flights Connectivity Network ($A_3$)", ylab = "logit proportion of non-zero estimates", main = "")


```

```{r GLASSO_vs_A3_2_logit_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 3, fig.width = 5, dev = "tikz"}
par(mar = c(3.5, 3.8, 1.5, 1.1)) # bottom, left, top, right
#par(mar = c(5.1, 4.1, 4.1, 2.1)) # Default
#par(mgp = c(3, 1, 0)) # Default - location of xlab and ylab, tick-mark labels, tick marks.
par(mgp = c(2.15, 1, 0))
...
logit_proportions <- log(non_zero_counts$x / zero_counts$x )
# Plot the scatter plot
plot(A3_plot_bin_mid, logit_proportions, xlab = "Flights Connectivity Network ($A_3$)", ylab = "logit$\\hat{P}[\\rho_{ij} \\neq 0 | A_3]$", main = "")
...
colnames(mydf_A1) <- sprintf('%s', 0:331)
...
# Transforming edge coordinates using usmap_transform function for both start and end points
edges_for_plot_A1_transformed <- usmap_transform(edges_for_plot_A1, input_names = c("x", "y"))   %>% arrange(to) %>% arrange(from)
edges_for_plot_A1_transformed2 <- usmap_transform(edges_for_plot_A1, input_names = c("xend", "yend"))   %>% arrange(to) %>% arrange(from)

# Merging transformed edge coordinates into a single data frame
merged_data_sf <- cbind(edges_for_plot_A1_transformed, edges_for_plot_A1_transformed2)
...
## NEW ## - below is my attemot at applying the above to Li's code

# Transforming edge coordinates using usmap_transform function for both start and end points
unique_A1_transformed <- usmap_transform(unique_A1_edges_for_plot, input_names = c("x", "y"))   %>% arrange(to) %>% arrange(from) 
unique_A1_transformed2 <- usmap_transform(unique_A1_edges_for_plot, input_names = c("xend", "yend"))   %>% arrange(to) %>% arrange(from)

# Merging transformed edge coordinates into a single data frame
unique_A1_merged_data_sf <- cbind(unique_A1_transformed, unique_A1_transformed2)



plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  geom_segment(data = unique_A1_merged_data_sf, 
               aes(x = st_coordinates(geometry)[,1], xend = st_coordinates(geometry.1)[,1],
                   y = st_coordinates(geometry)[,2], yend = st_coordinates(geometry.1)[,2]),
               color = "red", size = 0.35, alpha = 0.5) +
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) +
  labs(title = "Edges Unique in GOLAZO-A1",
       subtitle = "The Edges Estimated from GOLAZO - A1 but not GLASSO and US Map",
       size = "Magnitude") +
  theme(legend.position = "right")
...
```{r GOLAZO_A2, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE, error = TRUE}
...
```{r GOLAZO_A2_diag, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, error = TRUE}
...
```{r GOLAZO_A2_Map_Plot2, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, error = TRUE}
...
colnames(mydf_A2) <- sprintf('%s', 0:331)
...
```{r GOLAZO_A2_Map_Plot3, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, error = TRUE}
...
# Transforming edge coordinates using usmap_transform function for both start and end points
edges_for_plot_A2_transformed <- usmap_transform(edges_for_plot_A2, input_names = c("x", "y"))   %>% arrange(to) %>% arrange(from)
edges_for_plot_A2_transformed2 <- usmap_transform(edges_for_plot_A2, input_names = c("xend", "yend"))    %>% arrange(to) %>% arrange(from)

# Merging transformed edge coordinates into a single data frame
merged_data_sf <- cbind(edges_for_plot_A2_transformed, edges_for_plot_A2_transformed2)
...
plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  ...
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) +
  labs(title = "Facebook Network of GOLAZO - A2",
...
```{r GOLAZO_A2_Map_Plot3_tikz, include=TRUE,echo=TRUE, eval=FALSE, cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz", error = TRUE}
...
```{r GOLAZO_unique_A2_Map_Plot2, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, error = TRUE}
...
```{r GOLAZO_unique_A2_Map_Plot3, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, error = TRUE}
...
# Transforming edge coordinates using usmap_transform function for both start and end points
unique_A2_transformed <- usmap_transform(unique_A2_edges_for_plot, input_names = c("x", "y"))   %>% arrange(to) %>% arrange(from)
unique_A2_transformed2 <- usmap_transform(unique_A2_edges_for_plot, input_names = c("xend", "yend"))   %>% arrange(to) %>% arrange(from)

# Merging transformed edge coordinates into a single data frame
unique_A2_merged_data_sf <- cbind(unique_A2_transformed, unique_A2_transformed2)



plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  geom_segment(data = unique_A2_merged_data_sf, 
               aes(x = st_coordinates(geometry)[,1], xend = st_coordinates(geometry.1)[,1],
                   y = st_coordinates(geometry)[,2], yend = st_coordinates(geometry.1)[,2]),
               color = "red", size = 0.35, alpha = 0.5) +
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
  ...
  labs(title = "Edges Unique in GOLAZO-A2",
       subtitle = "The Edges Estimated from GOLAZO - A2 but not GLASSO and US Map",
       size = "Magnitude") +
  theme(legend.position = "right")
...
```{r GOLAZO_unique_A2_Map_Plot3_tikz, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz", error = TRUE}
...
```{r GOLAZO_A3, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE}
...
```{r GOLAZO_A3_diag, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE}
...
```{r GOLAZO_A1A2, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE,  error = TRUE}
...
```{r GOLAZO_A1A2_diag, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
```{r GOLAZO_A1A2_Map_Plot2, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
colnames(mydf_A1A2) <- sprintf('%s', 0:331)
...
```{r GOLAZO_A1A2_Map_Plot3, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
# Transforming edge coordinates using usmap_transform function for both start and end points
edges_for_plot_A1A2_transformed <- usmap_transform(edges_for_plot_A1A2, input_names = c("x", "y"))   %>% arrange(to) %>% arrange(from)
edges_for_plot_A1A2_transformed2 <- usmap_transform(edges_for_plot_A1A2, input_names = c("xend", "yend"))   %>% arrange(to) %>% arrange(from)

# Merging transformed edge coordinates into a single data frame
merged_data_sf <- cbind(edges_for_plot_A1A2_transformed, edges_for_plot_A2A2_transformed2)
...
plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  ...
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) +
  labs(title = "Geospatial and Facebook Network of GOLAZO - A1 \\& A2",
...
```{r GOLAZO_A1A2_Map_Plot3_tikz, include=TRUE,echo=TRUE, eval=FALSE, cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz",  error = TRUE}
...
```{r GOLAZO_unique_A1A2_Map_Plot2, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
```{r GOLAZO_unique_A1A2_Map_Plot3, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE}
...
```{r GOLAZO_unique_A1A2_Map_Plot3_tikz, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz",  error = TRUE}
...
```{r GOLAZO_A1A3, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE,  error = TRUE}
...
```{r GOLAZO_A1A3_diag, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
```{r GOLAZO_A2A3, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE,  error = TRUE}
...
```{r GOLAZO_A2A3_diag, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
```{r GOLAZO_A1A2A3, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE,  error = TRUE}
...
```{r GOLAZO_A1A2A3_diag, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
```{r full_comparison, include=TRUE,echo=TRUE, eval=FALSE, cache=FALSE,  error = TRUE}
...
```{r hyperparameters_0.5, include=TRUE,echo=TRUE, eval=FALSE, cache=TRUE, error = TRUE}
...
```{r GLASSO_run_0.5, include=TRUE,echo=TRUE, eval=FALSE, cache=TRUE, error = TRUE}
...
```{r GLASSO_diag_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, error = TRUE}
...
```{r Theta_vs_A1_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE, error = TRUE}
...
```{r Theta_vs_A2_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE, error = TRUE}
...
```{r Theta_vs_A3_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE, error = TRUE}
...
```{r GOLAZO_A1_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE, error = TRUE}
...
```{r GOLAZO_A1_diag_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, error = TRUE}
...
```{r GOLAZO_A2_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE, error = TRUE}
...
```{r GOLAZO_A2_diag_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE, error = TRUE}
...
```{r GOLAZO_A3_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE}
...
```{r GOLAZO_A3_diag_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE}
...
```{r GOLAZO_A1A2_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE,  error = TRUE}
...
```{r GOLAZO_A1A2_diag_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
```{r GOLAZO_A1A3_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE,  error = TRUE}
...
```{r GOLAZO_A1A3_diag_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
```{r GOLAZO_A2A3_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE,  error = TRUE}
...
```{r GOLAZO_A2A3_diag_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
```{r GOLAZO_A1A2A3_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=TRUE,  error = TRUE}
...
```{r GOLAZO_A1A2A3_diag_0.5, include=TRUE,echo=TRUE, eval=FALSE,cache=FALSE,  error = TRUE}
...
```{r full_comparison_0.5, include=TRUE,echo=TRUE, eval=FALSE, cache=FALSE,  error = TRUE}
...
### US MAPS from Final Bayesian Model

Remember we had errors with the second MCMC 

```{r NetworkSS_Map_Plot, include=TRUE,echo=TRUE, eval=TRUE, cache=FALSE}

setwd(data_dir)

#covid_nonzero_preds_50_mat <- read_csv("covid_nonzero_preds_50_mat.csv")[,-1]
#covid_nonzero_preds_95_mat <- read_csv("covid_nonzero_preds_95_mat.csv")[,-1]
#covid_nonzero_preds_50_mat_regression <- read_csv("nonzero_preds_50_mat_regression.csv")[,-1]
#covid_nonzero_preds_95_mat_regression <- read_csv("nonzero_preds_95_mat_regression.csv")[,-1]

#sum(covid_nonzero_preds_95_mat)
#sum(covid_nonzero_preds_95_mat_regression)

#sum(covid_nonzero_preds_95_mat*covid_nonzero_preds_95_mat_regression)

#sum(covid_nonzero_preds_50_mat)
#sum(covid_nonzero_preds_50_mat_regression)

#sum(covid_nonzero_preds_50_mat*covid_nonzero_preds_50_mat_regression)

covid_nonzero_preds_50_mat_regression <- read_csv("nonzero_preds_50_mat_seed_6_9.csv")[,-1]
covid_nonzero_preds_95_mat_regression <- read_csv("nonzero_preds_95_mat_seed_6_9.csv")[,-1]

sum(covid_nonzero_preds_50_mat_regression)
sum(covid_nonzero_preds_95_mat_regression)
```
*RUN CHUNK ON LINE 465 FIRST*


```{r NetworkSS_Map_Plot2_50, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}


# ## edges connection for GLASSO
#par_corr_GLASSO <- read_csv("mRho_hat_GLASSO.csv")[, -1] 
#par_corr_GLASSO <- covid_nonzero_preds_95_mat 
par_corr_GLASSO <- covid_nonzero_preds_50_mat_regression
m1 <- par_corr_GLASSO


#ERROR
colnames(m1)## one is index from 0 and 1 from 1
rownames(m1)
colnames(m1) <- paste0(0:(p-1)) #IMPORTANT
rownames(m1) <- paste0(0:(p-1)) #IMPORTANT
...
edges_NetworkSS_50 <- m1[m1$corr != 0, ]      ## only keep those rows that corr != 0


edges_NetworkSS_50 <- edges_NetworkSS_50 %>%  
  mutate(from = as.numeric(from), to = as.numeric(to))   ##convert the type to be consistant with "nodes"

edges_for_plot <- edges_NetworkSS_50 %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('from' = 'id')) %>%
  rename(x = lon, y = lat) %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('to' = 'id')) %>%
  rename(xend = lon, yend = lat)           ## define the start(from(x,y)) and end(to(xend,yend)) point for each edges
...
```{r NetworkSS_Map_Plot3_50, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}
...
plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  ...
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) +
  labs(title = "Geospatial Network of Spike-and-Slab",
       subtitle = "The Edges Estimated from Network-SS (0.5) and US Map",
       size = "Magnitude") +
  theme(legend.position = "right", plot.margin = unit(c(0.25,0,0,0), "cm"))
#top, right, bottom, left
...
```{r NetworkSS_Map_Plot3_50_tikz, include=TRUE,echo=TRUE, eval=TRUE, cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz"}
...
```{r NetworkSS_Map_Plot2_95, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

# ## edges connection for GLASSO
#par_corr_GLASSO <- read_csv("mRho_hat_GLASSO.csv")[, -1] 
par_corr_GLASSO <- covid_nonzero_preds_95_mat_regression 
m1 <- par_corr_GLASSO
...
edges_NetworkSS_95 <- m1[m1$corr != 0, ]      ## only keep those rows that corr != 0


edges_NetworkSS_95 <- edges_NetworkSS_95 %>%  
  mutate(from = as.numeric(from), to = as.numeric(to))   ##convert the type to be consistant with "nodes"

edges_for_plot <- edges_NetworkSS_95 %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('from' = 'id')) %>%
  rename(x = lon, y = lat) %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('to' = 'id')) %>%
  rename(xend = lon, yend = lat)           ## define the start(from(x,y)) and end(to(xend,yend)) point for each edges
...
```{r NetworkSS_Map_Plot3_95, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}
...
plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  ...
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) +
  labs(title = "Geospatial Network of Spike-and-Slab",
       subtitle = "The Edges Estimated from Network-SS (0.95) and US Map",
       size = "Magnitude") +
  theme(legend.position = "right", plot.margin = unit(c(0.25,0,0,0), "cm"))
#top, right, bottom, left
```

```{r NetworkSS_Map_Plot3_95_tikz, include=TRUE,echo=TRUE, eval=TRUE, cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz"}
...
```{r SS_Map_Plot, include=TRUE,echo=TRUE, eval=TRUE, cache=FALSE}

setwd(data_dir)

covid_nonzero_preds_50_mat_nonetwork_regression <- read_csv("nonzero_preds_50_mat_nonetworks_seed9.csv")[,-1]
covid_nonzero_preds_95_mat_nonetwork_regression <- read_csv("nonzero_preds_95_mat_nonetworks_seed9.csv")[,-1]

sum(covid_nonzero_preds_50_mat_nonetwork_regression)
sum(covid_nonzero_preds_95_mat_nonetwork_regression)

sum(covid_nonzero_preds_50_mat_regression)
sum(covid_nonzero_preds_95_mat_regression)


sum(covid_nonzero_preds_50_mat_regression*covid_nonzero_preds_50_mat_nonetwork_regression)
sum(covid_nonzero_preds_95_mat_regression*covid_nonzero_preds_95_mat_nonetwork_regression)

```


```{r SS_Map_Plot2_50, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}


# ## edges connection for GLASSO
#par_corr_GLASSO <- read_csv("mRho_hat_GLASSO.csv")[, -1] 
#par_corr_GLASSO <- covid_nonzero_preds_95_mat 
par_corr_GLASSO <- covid_nonzero_preds_50_mat_nonetwork_regression
m1 <- par_corr_GLASSO
...
edges_SS_50 <- m1[m1$corr != 0, ]      ## only keep those rows that corr != 0


edges_SS_50 <- edges_SS_50 %>%  
  mutate(from = as.numeric(from), to = as.numeric(to))   ##convert the type to be consistant with "nodes"

edges_for_plot <- edges_SS_50 %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('from' = 'id')) %>%
  rename(x = lon, y = lat) %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('to' = 'id')) %>%
  rename(xend = lon, yend = lat)           ## define the start(from(x,y)) and end(to(xend,yend)) point for each edges
...
```{r SS_Map_Plot3_50, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}
...
plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  ...
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) +
  labs(title = "Geospatial Network of Spike-and-Slab",
       subtitle = "The Edges Estimated from SS (0.5) and US Map",
       size = "Magnitude") +
  theme(legend.position = "right", plot.margin = unit(c(0.25,0,0,0), "cm"))
#top, right, bottom, left
...
```{r SS_Map_Plot3_50_tikz, include=TRUE,echo=TRUE, eval=TRUE, cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz"}
...
```{r SS_Map_Plot2_95, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

# ## edges connection for GLASSO
#par_corr_GLASSO <- read_csv("mRho_hat_GLASSO.csv")[, -1] 
par_corr_GLASSO <- covid_nonzero_preds_95_mat_nonetwork_regression 
m1 <- par_corr_GLASSO
...
edges_SS_95 <- m1[m1$corr != 0, ]      ## only keep those rows that corr != 0


edges_SS_95 <- edges_SS_95 %>%  
  mutate(from = as.numeric(from), to = as.numeric(to))   ##convert the type to be consistant with "nodes"

edges_for_plot <- edges_SS_95 %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('from' = 'id')) %>%
  rename(x = lon, y = lat) %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('to' = 'id')) %>%
  rename(xend = lon, yend = lat)           ## define the start(from(x,y)) and end(to(xend,yend)) point for each edges
...
```{r SS_Map_Plot3_95, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}
...
plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  ...
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) +
  labs(title = "Geospatial Network of Spike-and-Slab",
       subtitle = "The Edges Estimated from SS (0.95) and US Map",
       size = "Magnitude") +
  theme(legend.position = "right", plot.margin = unit(c(0.25,0,0,0), "cm"))
#top, right, bottom, left
```

```{r SS_Map_Plot3_95_tikz, include=TRUE,echo=TRUE, eval=TRUE, cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz"}
...
### US MAPS Final Bayesian Model - edges added by Network-SS that didn't exist under SS 

Need to extrac nodes that were capture by network SS but not by SS

### Unique edges A1 (and not GLASSO)

```{r NetworkSS_unique_Map_Plot2_50, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

edges_SS_50_check <- dplyr::select(edges_SS_50, -corr)
edges_NetworkSS_50_check <- dplyr::select(edges_NetworkSS_50, -corr)


unique_Network <- dplyr::setdiff(edges_NetworkSS_50_check, edges_SS_50_check)   ## unique for edges_A1_check

both <- intersect(edges_NetworkSS_50_check, edges_SS_50_check)  ## in both dataframe

## merge with edges
unique_Network_edges <- merge(unique_Network, edges_NetworkSS_50, by = c("from", "to"))
unique_Network_edges <- arrange(unique_Network_edges, from, to) 


unique_Network_edges_for_plot <- unique_Network_edges %>%
  #inner_join(nodes %>% dplyr::select(id, lon, lat), by = c('from' = 'id')) %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('from' = 'id')) %>%
  rename(x = lon, y = lat) %>%
  #inner_join(nodes %>% dplyr::select(id, lon, lat), by = c('to' = 'id')) %>%
...
```{r NetworkSS_unique_Map_Plot3_50, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

## OLD ##

unique_Network_edges_for_plot <- unique_Network_edges_for_plot[, c(4, 5, 6, 7, 1, 2, 3)]
#unique_A1_transformed <- usmap_transform(unique_A1_edges_for_plot, input_names = c("x", "y"), output_names = c("x.1", "y.1"))
#unique_A1_transformed <- unique_A1_transformed[, c(3, 4, 5, 6, 7, 8, 9, 1, 2)]
#unique_A1_transformed <- usmap_transform(unique_A1_transformed, input_names = c("xend", "yend"), output_names = c("xend.1", "yend.1"))
...
# Transforming edge coordinates using usmap_transform function for both start and end points
unique_Network_transformed <- usmap_transform(unique_Network_edges_for_plot, input_names = c("x", "y"))  %>% arrange(to) %>% arrange(from)
unique_Network_transformed2 <- usmap_transform(unique_Network_edges_for_plot, input_names = c("xend", "yend"))  %>% arrange(to) %>% arrange(from)

# Merging transformed edge coordinates into a single data frame
unique_Network_merged_data_sf <- cbind(unique_Network_transformed, unique_Network_transformed2)



plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  geom_segment(data = unique_Network_merged_data_sf, 
               aes(x = st_coordinates(geometry)[,1], xend = st_coordinates(geometry.1)[,1],
                   y = st_coordinates(geometry)[,2], yend = st_coordinates(geometry.1)[,2]),
               color = "red", size = 0.35, alpha = 0.5) +
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) +
  labs(title = "Edges Unique in Network-SS",
       subtitle = "The Edges Estimated from Network-SS but not SS and US Map",
       size = "Magnitude") +
  theme(legend.position = "right")
...
```{r NetworkSS_unique_Map_Plot3_50_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz"}
...
```{r NetworkSS_unique_Map_Plot2_95, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

edges_SS_95_check <- dplyr::select(edges_SS_95, -corr)
edges_NetworkSS_95_check <- dplyr::select(edges_NetworkSS_95, -corr)


unique_Network <- dplyr::setdiff(edges_NetworkSS_95_check, edges_SS_95_check)   ## unique for edges_A1_check

both <- dplyr::intersect(edges_NetworkSS_95_check, edges_SS_95_check)  ## in both dataframe

## merge with edges
unique_Network_edges <- merge(unique_Network, edges_NetworkSS_95, by = c("from", "to"))
unique_Network_edges <- arrange(unique_Network_edges, from, to) 
...
```{r NetworkSS_unique_Map_Plot3_95, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}
...
```{r NetworkSS_unique_Map_Plot3_95_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz"}
...
*COULD ALSO LOOK AT UNIQUE NONETWORK*

### Unique edges SS (and not Network SS)

```{r SS_unique_Map_Plot2_50, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

edges_SS_50_check <- dplyr::select(edges_SS_50, -corr)
edges_NetworkSS_50_check <- dplyr::select(edges_NetworkSS_50, -corr)


unique_SS <- dplyr::setdiff(edges_SS_50_check, edges_NetworkSS_50_check)   ## unique for edges_A1_check

both <- intersect(edges_NetworkSS_50_check, edges_SS_50_check)  ## in both dataframe

## merge with edges
unique_SS_edges <- merge(unique_SS, edges_SS_50, by = c("from", "to"))
unique_SS_edges <- arrange(unique_SS_edges, from, to) 


unique_SS_edges_for_plot <- unique_SS_edges %>%
  #inner_join(nodes %>% dplyr::select(id, lon, lat), by = c('from' = 'id')) %>%
  inner_join(nodes_new %>% dplyr::select(id, lon, lat), by = c('from' = 'id')) %>%
  rename(x = lon, y = lat) %>%
  #inner_join(nodes %>% dplyr::select(id, lon, lat), by = c('to' = 'id')) %>%
...
```{r SS_unique_Map_Plot3_50, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

## OLD ##

unique_SS_edges_for_plot <- unique_SS_edges_for_plot[, c(4, 5, 6, 7, 1, 2, 3)]
#unique_A1_transformed <- usmap_transform(unique_A1_edges_for_plot, input_names = c("x", "y"), output_names = c("x.1", "y.1"))
#unique_A1_transformed <- unique_A1_transformed[, c(3, 4, 5, 6, 7, 8, 9, 1, 2)]
#unique_A1_transformed <- usmap_transform(unique_A1_transformed, input_names = c("xend", "yend"), output_names = c("xend.1", "yend.1"))
...
# Transforming edge coordinates using usmap_transform function for both start and end points
unique_SS_transformed <- usmap_transform(unique_SS_edges_for_plot, input_names = c("x", "y"))  %>% arrange(to) %>% arrange(from)
unique_SS_transformed2 <- usmap_transform(unique_SS_edges_for_plot, input_names = c("xend", "yend"))  %>% arrange(to) %>% arrange(from)

# Merging transformed edge coordinates into a single data frame
unique_SS_merged_data_sf <- cbind(unique_SS_transformed, unique_SS_transformed2)



plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  geom_segment(data = unique_SS_merged_data_sf, 
               aes(x = st_coordinates(geometry)[,1], xend = st_coordinates(geometry.1)[,1],
                   y = st_coordinates(geometry)[,2], yend = st_coordinates(geometry.1)[,2]),
               color = "red", size = 0.35, alpha = 0.5) +
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) +
  labs(title = "Edges Unique in SS",
       subtitle = "The Edges Estimated from SS but not NetworkSS and US Map",
       size = "Magnitude") +
  theme(legend.position = "right")
...
```{r SS_unique_Map_Plot3_50_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz"}
...
plot_usmap(fill = "white", color = "#2b2b2b", alpha = 0.25) +
  ...
  geom_point(data = nodes_transformed, aes(x = st_coordinates(geometry)[,1], y =st_coordinates(geometry)[,2]),
          fill = alpha("#b30000", 1/2), color = "#b30000", shape=21) #+
  #labs(title = "Edges Unique in SS",
  #     subtitle = "The Edges Estimated from SS but not Network-SS and US Map",
  #     size = "Magnitude") +
  #theme(legend.position = "right")
...
```{r SS_unique_Map_Plot2_95, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}

edges_SS_95_check <- dplyr::select(edges_SS_95, -corr)
edges_NetworkSS_95_check <- dplyr::select(edges_NetworkSS_95, -corr)


unique_SS <- dplyr::setdiff(edges_SS_95_check, edges_NetworkSS_95_check)   ## unique for edges_A1_check

both <- intersect(edges_NetworkSS_95_check, edges_SS_95_check)  ## in both dataframe

## merge with edges
unique_SS_edges <- merge(unique_SS, edges_SS_95, by = c("from", "to"))
unique_SS_edges <- arrange(unique_SS_edges, from, to) 
...
```{r SS_unique_Map_Plot3_95, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE}
...
```{r SS_unique_Map_Plot3_95_tikz, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE, fig.height = 4, fig.width = 7, dev = "tikz"}
