---
title: "COVID Frequentist GLASSO and GOLAZO Out-Sample cv10 Analysis"
author: "Jack Jewson"
date: "19/07/2022"
...
Now when we strat doing BayesOpt we have problems with the initalisation - Now I developed functions that would help he do that before - test and add in (I think the problem we had was they were slow)
...
```{r GOLAZO_A3, include=TRUE,echo=TRUE, eval=TRUE,cache=TRUE, error = TRUE}
...
GOLAZO_A3_sim_results <- foreach(j=1:N, .combine = 'rbind',.packages = c("stats", "mvtnorm", "rBayesianOptimization"), .export = c("golazo", "pd.solve")) %dopar% {
  ...
  beta_GOLAZO_A3 <- beta_optimise$Best_Par
  # JACK: Saving the EBIC 
  ebic_eval_optim_GOLAZO_A3 <- - beta_optimise$Best_Value
  
  #### Using the optimal beta0 ##
  # U <- exp(beta0 + beta1*A3) 
  U <- exp(beta_GOLAZO_A3[1] + beta_GOLAZO_A3[2]*A3) 
  ...
  Rho_hat_GOLAZO_A3 <- threshold(cov2cor(res$K), edge.tol)
  
  #out-of-sample log-likelihood
  n_test <- nrow(test_data[[j]])
  
  out_sample_llh_GOLAZO_A3 <- 1/n_test*sum(dmvnorm(test_data[[j]], mean = rep(0, p), sigma = cor2cov(cov2cor(solve(Rho_hat_GOLAZO_A3)), diag(cov(train_data[[j]]))), log = TRUE))
  
  #cat("fold", j, "done", "\n")
  c(beta_GOLAZO_A3, ebic_eval_optim_GOLAZO_A3, out_sample_llh_GOLAZO_A3)
...
```{r GOLAZO_A3_diag, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE,  error = TRUE}

GOLAZO_A3_sim_results

mean(GOLAZO_A3_sim_results[,3])
mean(GOLAZO_A3_sim_results[,4])
...
GOLAZO_A1A3_sim_results <- foreach(j=1:N, .combine = 'rbind',.packages = c("stats", "mvtnorm", "rBayesianOptimization"), .export = c("golazo", "pd.solve")) %dopar% {
  ...
  beta_GOLAZO_A1A3 <- beta_optimise$Best_Par
  # JACK: Saving the EBIC 
  ebic_eval_optim_GOLAZO_A1A3 <- - beta_optimise$Best_Value
  
  #### Using the optimal beta0 ##
  # U <- exp(beta0 + beta1*A1 + beta2*A3) 
  U <- exp(beta_GOLAZO_A1A3[1] + beta_GOLAZO_A1A3[2]*A1 + beta_GOLAZO_A1A3[3]*A3) 
  ...
  Rho_hat_GOLAZO_A1A3 <- threshold(cov2cor(res$K), edge.tol)

  #out-of-sample log-likelihood
  n_test <- nrow(test_data[[j]])
  
  out_sample_llh_GOLAZO_A1A3 <- 1/n_test*sum(dmvnorm(test_data[[j]], mean = rep(0, p), sigma = cor2cov(cov2cor(solve(Rho_hat_GOLAZO_A1A3)), diag(cov(train_data[[j]]))), log = TRUE))
  
  #cat("fold", j, "done", "\n")
  c(beta_GOLAZO_A1A3, ebic_eval_optim_GOLAZO_A1A3, out_sample_llh_GOLAZO_A1A3)
...
GOLAZO_A1A3_sim_results

mean(GOLAZO_A1A3_sim_results[,4])
mean(GOLAZO_A1A3_sim_results[,5])
...
GOLAZO_A2A3_sim_results <- foreach(j=1:N, .combine = 'rbind',.packages = c("stats", "mvtnorm", "rBayesianOptimization"), .export = c("golazo", "pd.solve")) %dopar% {
  ...
  beta_GOLAZO_A2A3 <- beta_optimise$Best_Par
  # JACK: Saving the EBIC 
  ebic_eval_optim_GOLAZO_A2A3 <- - beta_optimise$Best_Value
  
  #### Using the optimal beta0 ##
  # U <- exp(beta0 + beta1*A2 + beta2*A3) 
  U <- exp(beta_GOLAZO_A2A3[1] + beta_GOLAZO_A2A3[2]*A2 + beta_GOLAZO_A2A3[3]*A3) 
  ...
  Rho_hat_GOLAZO_A2A3 <- threshold(cov2cor(res$K), edge.tol)

  #out-of-sample log-likelihood
  n_test <- nrow(test_data[[j]])
  
  out_sample_llh_GOLAZO_A2A3 <- 1/n_test*sum(dmvnorm(test_data[[j]], mean = rep(0, p), sigma = cor2cov(cov2cor(solve(Rho_hat_GOLAZO_A2A3)), diag(cov(train_data[[j]]))), log = TRUE))
  
  #cat("fold", j, "done", "\n")
  c(beta_GOLAZO_A2A3, ebic_eval_optim_GOLAZO_A2A3, out_sample_llh_GOLAZO_A2A3)
...
GOLAZO_A2A3_sim_results

mean(GOLAZO_A2A3_sim_results[,4])
mean(GOLAZO_A2A3_sim_results[,5])
```
...
GOLAZO_A1A2A3_sim_results <- foreach(j=1:N, .combine = 'rbind',.packages = c("stats", "mvtnorm", "rBayesianOptimization"), .export = c("golazo", "pd.solve")) %dopar% {
  ...
  beta_GOLAZO_A1A2A3 <- beta_optimise$Best_Par
  # JACK: Saving the EBIC 
  ebic_eval_optim_GOLAZO_A1A2A3 <- - beta_optimise$Best_Value
  
  #### Using the optimal beta0 ##
  U <- exp(beta_GOLAZO_A1A2A3[1] + beta_GOLAZO_A1A2A3[2]*A1 + beta_GOLAZO_A1A2A3[3]*A2 + beta_GOLAZO_A1A2A3[4]*A3) 
  ...
  Rho_hat_GOLAZO_A1A2A3 <- threshold(cov2cor(res$K), edge.tol)

  #out-of-sample log-likelihood
  n_test <- nrow(test_data[[j]])
  
  out_sample_llh_GOLAZO_A1A2A3 <- 1/n_test*sum(dmvnorm(test_data[[j]], mean = rep(0, p), sigma = cor2cov(cov2cor(solve(Rho_hat_GOLAZO_A1A2A3)), diag(cov(train_data[[j]]))), log = TRUE))
  
  #cat("fold", j, "done", "\n")
  c(beta_GOLAZO_A1A2A3, ebic_eval_optim_GOLAZO_A1A2A3, out_sample_llh_GOLAZO_A1A2A3)
...
GOLAZO_A1A2A3_sim_results

mean(GOLAZO_A1A2A3_sim_results[,5])
mean(GOLAZO_A1A2A3_sim_results[,6])
...
GOLAZO_A3_sim_results[,3]
GOLAZO_A1A2_sim_results[,4]
GOLAZO_A1A3_sim_results[,4]
GOLAZO_A2A3_sim_results[,4]
GOLAZO_A1A2A3_sim_results[,5]
...
GOLAZO_A3_sim_results[,1]
GOLAZO_A3_sim_results[,2]
GOLAZO_A1A2_sim_results[,1]
GOLAZO_A1A2_sim_results[,2]
GOLAZO_A1A2_sim_results[,3]
GOLAZO_A1A3_sim_results[,1]
GOLAZO_A1A3_sim_results[,2]
GOLAZO_A1A3_sim_results[,3]
GOLAZO_A2A3_sim_results[,1]
GOLAZO_A2A3_sim_results[,2]
GOLAZO_A2A3_sim_results[,3]
GOLAZO_A1A2A3_sim_results[,1]
GOLAZO_A1A2A3_sim_results[,2]
GOLAZO_A1A2A3_sim_results[,3]
GOLAZO_A1A2A3_sim_results[,4]

mean(GLASSO_sim_results[,3])*round(nrow(covid1)/N_folds)
mean(GOLAZO_A1_sim_results[,4])*round(nrow(covid1)/N_folds)
mean(GOLAZO_A2_sim_results[,4])*round(nrow(covid1)/N_folds)
mean(GOLAZO_A3_sim_results[,4])*round(nrow(covid1)/N_folds)
mean(GOLAZO_A1A2_sim_results[,5])*round(nrow(covid1)/N_folds)
mean(GOLAZO_A1A3_sim_results[,5])*round(nrow(covid1)/N_folds)
mean(GOLAZO_A2A3_sim_results[,5])*round(nrow(covid1)/N_folds)
mean(GOLAZO_A1A2A3_sim_results[,6])*round(nrow(covid1)/N_folds)

GLASSO_sim_results[,3]
GOLAZO_A1_sim_results[,4]
GOLAZO_A2_sim_results[,4]
GOLAZO_A3_sim_results[,4]
GOLAZO_A1A2_sim_results[,5]
GOLAZO_A1A3_sim_results[,5]
GOLAZO_A2A3_sim_results[,5]
GOLAZO_A1A2A3_sim_results[,6]

sqrt(var(GLASSO_sim_results[,3]))/sqrt(N)
sqrt(var(GOLAZO_A1_sim_results[,4]))/sqrt(N)
sqrt(var(GOLAZO_A2_sim_results[,4]))/sqrt(N)
sqrt(var(GOLAZO_A3_sim_results[,4]))/sqrt(N)
sqrt(var(GOLAZO_A1A2_sim_results[,5]))/sqrt(N)
sqrt(var(GOLAZO_A1A3_sim_results[,5]))/sqrt(N)
sqrt(var(GOLAZO_A2A3_sim_results[,5]))/sqrt(N)
sqrt(var(GOLAZO_A1A2A3_sim_results[,6]))/sqrt(N)
...
#for(j in 1:N){
GLASSO_sim_results <- foreach(j=1:N, .combine = 'rbind', .packages = c("stats", "mvtnorm", "rBayesianOptimization"), .export = c("golazo", "pd.solve", "beta0_max_GLASSO")) %dopar% {
...
```{r Theta_vs_A3_0.5, include=TRUE,echo=TRUE, eval=TRUE,cache=TRUE}
...
```{r GOLAZO_A3_0.5, include=TRUE,echo=TRUE, eval=TRUE,cache=TRUE, error = TRUE}
...
```{r GOLAZO_A3_diag_0.5, include=TRUE,echo=TRUE, eval=TRUE,cache=FALSE,  error = TRUE}
